    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/enrollment-requests/{courseId}/cancel").hasRole("STUDENT")
                        .requestMatchers("/api/v1/enrollment-requests/{courseId}/accept").hasRole("TEACHER")
                        .requestMatchers("/api/v1/enrollment-requests/{courseId}/reject").hasRole("TEACHER")
